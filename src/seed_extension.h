...
public:
    ...
    )
    {
        ...
        S1IndexType opt_l1 = l1;
        S2IndexType opt_l2 = l2;
        while(l1 > 0 && l2 > 0 && curr_score > lower_bound)
        {
            ...
            if(curr_score >= opt_score)     // if extension is able to be made, record it even with the same score
            {
                ...
                opt_mismatch = curr_mismatch, opt_l1 = l1;
                opt_l2 = l2;
            }
            //if(tl2 == 23 && tr2 == 54)
        ...
        S1IndexType opt_r1 = r1;
        S2IndexType opt_r2 = r2;
    ...
    )
    {
        ...
        for(int i = 1; i <= max_gap_size; ++ i)
        {
            ...
            while(l1 > 0 && l2 > 0 && curr_score > lower_bound)
            {
                ...
                {
                    opt_score = curr_score + gap_penalty;
                    opt_mismatch = curr_mismatch;
                    opt_l1 = l1;
                    opt_l2 = l2;
                    lsize = i;
